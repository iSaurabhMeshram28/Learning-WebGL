...
function initialize() {
  ...
  //for PerVertex
  var vertexShaderSourceCode_pv = `#version 300 es
  ...
  var fragmentShaderSourceCode_pv = `#version 300 es
    precision highp float;
    precision highp int;
    in vec4 oColor; 
  ...
  // Per Fragment Shader
  var vertexShaderSourceCode_pf = `#version 300 es
    precision highp float;
    precision highp int;
           in vec4 aPosition; 
        in vec3 aNormal; 
  ...
  var fragmentShaderSourceCode_pf = `#version 300 es
    precision highp float;
    precision highp int;
   in vec4 oColor; 
